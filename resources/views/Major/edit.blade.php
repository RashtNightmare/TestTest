...
<span style="background-color:blue;color:white;" class="text-gray-700">USERS</span>   
      ...
      <input value="{{$majors['name']}}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name"  name="name" type="text" placeholder="Name">
    </div>
