...
<span style="background-color:blue;color:white;" class="text-gray-700">STUDENT TESTS</span>   
    ...
    <div class="mb-4">
      ...
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="paid"  name="paid" type="text" placeholder="Paid">
    </div>
    <div class="mb-4">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="name">
      Canceled
      </label>
      <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="canceled"  name="canceled" type="text" placeholder="Canceled">
    </div>
